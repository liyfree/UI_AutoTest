...
/**
 * Created by huangyan on 2021/3/22下午8:47.
 */
 ...
 * @description: 生成ExtentReport报告监听器
 * @author: liyang
 * @create: 2021-03-22 20:47
 **/
public class ExtentTestNGIReporterListener implements IReporter {

    private final static Logger logger = LoggerFactory.getLogger(ExtentTestNGIReporterListener.class);
